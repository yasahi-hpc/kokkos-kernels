...
/// 2D view \param piv [in]: The pivot indices; for 0 <= i < N, row i of the
/// matrix was interchanged with row piv(i). \param A [inout]: A is a lda by n
/// banded matrix. The matrix of column dimension N to which the row
/// interchanges will be applied. No nested parallel_for is used inside of the
/// function.
///
