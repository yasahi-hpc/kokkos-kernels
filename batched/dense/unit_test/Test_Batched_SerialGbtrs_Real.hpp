...
// NO TRANSPOSE
TEST_F(TestCategory, batched_serial_gbtrs_nt_float) {
...
// TRANSPOSE
TEST_F(TestCategory, batched_serial_gbtrs_t_float) {
...
// NO TRANSPOSE
TEST_F(TestCategory, batched_serial_gbtrs_nt_double) {
  using param_tag_type = ::Test::Gbtrs::ParamTag<Trans::NoTranspose>;
  using algo_tag_type  = typename Algo::Gbtrs::Unblocked;
...
// TRANSPOSE
TEST_F(TestCategory, batched_serial_gbtrs_t_double) {
  using param_tag_type = ::Test::Gbtrs::ParamTag<Trans::Transpose>;
  using algo_tag_type  = typename Algo::Gbtrs::Unblocked;
